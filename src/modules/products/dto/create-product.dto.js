...
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Price", example: 99.99 }),
    (0, class_validator_1.IsNotEmpty)(),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Product quantity", required: false }),
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsNumber)(),
    (0, class_validator_1.IsPositive)(),
    __metadata("design:type", Number)
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Seller ID", format: "uuid" }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
], CreateProductDto.prototype, "sellerId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: "Subcategory ID", format: "uuid" }),
    (0, class_validator_1.IsNotEmpty)(),
    (0, class_validator_1.IsUUID)(),
    __metadata("design:type", String)
